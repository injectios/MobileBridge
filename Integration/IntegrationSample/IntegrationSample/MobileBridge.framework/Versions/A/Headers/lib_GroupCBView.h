...
- (id)initWithFrameAndArray:(CGRect)frame groupCBType:(int)_groupCBType fontStyle:(NSDictionary*)_fontStyle indicator_color:(NSDictionary*)_indicator_color optionArr:(NSArray*)optionArr isProfile:(BOOL)isProfile;
