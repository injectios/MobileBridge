...
@optional
-(void)ActivatePromotion:(NSString*)activationCode;
-(void)CodeCollectionEvent:(NSString*)type code:(NSString*)code;
...
-(void)setCodeCollection:(NSString*)_codeCollection;
